/*
* Por Hacer: 
*   - Bajar el reloj a 4MHz para usar todo el rango de las baterías.
*/
...
#define MINUTOS_ENVIO 5 //Cada X minutos realizamos un envío.

//Tamaño de los datos enviados a Cayenne.
//Cada sensor añade al payload 2 bytes + los bytes de sus datos.
CayenneLPP lpp(8); //Térmometro + Lectura de batería
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        lpp.reset();
        lpp.addAnalogInput(1, ADC_BateriaLeerVoltaje()/1000.F); //Batería en Voltios.
        lpp.addAnalogInput(2, 25.3); //Añadimos el sensor de temperatura.
